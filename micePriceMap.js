...
Easy Loot
============================== */	
	["Savoury Vegetables", defaultValue],
	["Swiss Cheese", defaultValue],
	["Seashell", defaultValue],
	["Master Fang Shard", defaultValue],
	["Bolt of Cloth", defaultValue],
	["Packet of Flour", defaultValue],
	["Master Belt Shard", defaultValue],
	["Delicious Stone", defaultValue],
	["Divine Orb", defaultValue],
	["Cherry Potion", defaultValue],
	["Simple Orb", defaultValue],
	["Blue Pepper Seed", defaultValue],
	["Faceted Sugar", defaultValue],
	["Token of the Cheese Claw", defaultValue],
	["Coal", defaultValue],
	["Red Pepper Seed", defaultValue],
	["Brie Cheese", defaultValue],
	["Cheddar Cheese", defaultValue],
	["Iced Curd", defaultValue],
	["Ancient Potion", defaultValue],
	["Scrap Metal", defaultValue],
	["Stale SUPER|brie+", defaultValue],
	["Gnarled Potion", defaultValue],
	["Splintered Wood", defaultValue],
	["Master Claw Shard", defaultValue],
	["Crown Jewel", defaultValue],
	["Yellow Pepper Seed", defaultValue],
	["Token of the Cheese Fang", defaultValue],
	["Flawed Orb", defaultValue],
	["Marble Cheese", defaultValue],
	["Rope", defaultValue],
	["Super Power Charm", defaultValue],
	["Radioactive Blue Potion", defaultValue],
	["Stale Cheese", defaultValue],
	["Flawless Orb", defaultValue],
	["Token of the Cheese Belt", defaultValue],
	["Wicked Gnarly Potion", defaultValue],
	["Rune", defaultValue],
	
/* ==============================
Medium Loot
============================== */	
	["Vanilla Bean", defaultValue],
	["Coconut Milk", defaultValue],
	["Raisins of Wrath", defaultValue],
	["Dragon's Chest", defaultValue],
	["Onyx Stone", defaultValue],
	["Gauntlet Potion Tier 2", defaultValue],
	["Runic Potion", defaultValue],
	["Living Shard", defaultValue],
	["Master's Seal", defaultValue],
	["Dragon Ember", defaultValue],
	["Gauntlet Potion Tier 6", defaultValue],
	["Gauntlet Potion Tier 5", defaultValue],
	["Gauntlet Potion Tier 4", defaultValue],
	["Mysterious Box", defaultValue],
	["Gauntlet Potion Tier 3", defaultValue],
	["Bottled-Up Rage", defaultValue],
	["Fire Salt", defaultValue],
	["Pinch of Annoyance", defaultValue],

/* ==============================
Hard Loot
============================== */	
	["Flameshard", defaultValue],
	["Bottled Cold Fusion", defaultValue],
	["Heating Oil", defaultValue],
	["Aleth Essence", defaultValue],
	["Desert Horseshoe", defaultValue],
	["Dreamfluff Herbs", defaultValue],
	["Tower Mana", defaultValue],
	["Meteorite Piece", defaultValue],
	["Cynd Essence", defaultValue],
	["Lunaria Petal", defaultValue],
	["Dewthief Petal", defaultValue],
	["Greater Radioactive Blue Potion", defaultValue],
	["Heatproof Mage Cloth", defaultValue],
	["Dewdrop", defaultValue],
	["Plumepearl Herbs", defaultValue],
	["Sticky Charm", defaultValue],
	["Yellow Dewdrop", defaultValue],
	["Wax Charm", defaultValue],
	["Ber Essence", defaultValue],
	["Dawn Dust", defaultValue],
	["Limestone Brick", defaultValue],
	["Shard of Glass", defaultValue],
	["Technic Cheese Mould", defaultValue],
	["War Scrap", defaultValue],
	["Fool's Gold", defaultValue],
	["Red Dewdrop", defaultValue],
	["Duskshade Petal", defaultValue],
	["Howlite", defaultValue],
	["Graveblossom Petal", defaultValue],
	["Wire Spool", defaultValue],
	["Bloodstone", defaultValue],
	["Mystic Curd", defaultValue],
	["Frosty Metal", defaultValue],

/* ==============================
Elaborate Loot
============================== */	
	["Plate of Fealty", defaultValue],
	["Terre Ricotta Potion", defaultValue],
	["Medium Spice Leaf", defaultValue],
	["Tasty Spider Mould", defaultValue],
	["Calcified Rift Mist", defaultValue],
	["Mouse Scale", defaultValue],
	["Rift-torn Roots", defaultValue],
	["Riftiago Potion", defaultValue],
	["Polluted Parmesan Potion", defaultValue],
	["Crumbly Rift Salts", defaultValue],
	["Corrupted Radioactive Blue Potion", defaultValue],
	["Mist Canister", defaultValue],
	["Magmatic Crystal Charm", defaultValue],
	["Super Cactus Charm", defaultValue],
	["Crude Pollutinum", defaultValue],
	["Magic Seed", defaultValue],
	["Riftgrass", defaultValue],
	["Scholar Scroll", defaultValue],
	["Sand Dollar", defaultValue],
	["Soapy Suds", defaultValue],
	["Wild Tonic", defaultValue],
	["Sacred Script", defaultValue],
	["Nachore", defaultValue],
	["Ionized Salt", defaultValue],
	["Tech Power Core", defaultValue],
	["Creamy Gnarled Sap", defaultValue],
	["Nightshade", defaultValue],
	["Empowered Anchor Charm", defaultValue],
	["Mild Spice Leaf", defaultValue],
	["Gemstone", defaultValue],
	["Cactus Charm", defaultValue],
	["Cavern Fungus", defaultValue],
	["Ancient Relic", defaultValue],
	["Flamin' Spice Leaf", defaultValue],
	["Infused Plate", defaultValue],
	["SUPER|brie+", defaultValue],
	["Ember Root", defaultValue],
	["Magic Essence", defaultValue],
	["Damaged Coral Fragment", defaultValue],
	["Bland Queso", defaultValue],
	["Mineral", defaultValue],
	["Powercore Hammer", defaultValue],
	["Rift Cherries", defaultValue],
	["Hot Spice Leaf", defaultValue],
	["Rift Circuitry", defaultValue],
	["Unstable Ember Gadget", defaultValue],
	["Diamond", defaultValue],
	["Ember Stone", defaultValue],
	["Sap-filled Thorns", defaultValue],
	["Rift Dust", defaultValue],
	["Widow's Web", defaultValue],
	["Barnacle", defaultValue],
	["Crystal Crucible", defaultValue],

/* ==============================
Arduous Loot
============================== */	
	["Windy Potion", defaultValue],
	["Rift Blossom Branch", defaultValue],
	["Tiny Sprocket", defaultValue],
	["Chi Claw Token", defaultValue],
	["Shadowvine", defaultValue],
	["Chi Fang Token", defaultValue],
	["Ancient Hourglass", defaultValue],
	["Enerchi", defaultValue],
	["Chi Belt Token", defaultValue],
	["Null Onyx Stone", defaultValue],
	["Runic String Cheese Potion", defaultValue],
	["Chi Belt Heirloom", defaultValue],
	["Time Sand", defaultValue],
	["Ultimate Power Charm", defaultValue],
	["Quantum Quartz", defaultValue],
	["Rainy Potion", defaultValue],
	["Battery Fragment", defaultValue],
	["Dragon Scale", defaultValue],
	["Chi Fang Heirloom", defaultValue],
	["Chi Claw Heirloom", defaultValue],
	["Cork Bark", defaultValue],
	["Dol Essence", defaultValue],
	["Arcanevine", defaultValue],
	["Really, Really Shiny Precious Gold", defaultValue],

/* ==============================
Gilded Loot
============================== */	
	["Radioactive Sludge", defaultValue],

/* ==============================
Elite Loot (waiting for MHCT for list)
============================== */	
